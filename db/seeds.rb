...
categoria1.image.attach(io: File.open("app/app/assets/images/guitarra-electrica.png"), filename: "guitarra-electrica.png")
categoria2.image.attach(io: File.open("app/app/assets/images/bajos.png"), filename: "bajos.png")
categoria3.image.attach(io: File.open("app/app/assets/images/percusion.png"), filename: "percusion.png")
categoria4.image.attach(io: File.open("app/app/assets/images/orquesta.png"), filename: "orquesta.png")
categoria5.image.attach(io: File.open("app/app/assets/images/teclados.png"), filename: "teclados.png")
categoria6.image.attach(io: File.open("app/app/assets/images/piano.png"), filename: "piano.png")
categoria7.image.attach(io: File.open("app/app/assets/images/controlador_iluminacion.jpg"), filename: "controlador_iluminacion.jpg")
categoria8.image.attach(io: File.open("app/app/assets/images/proyectores.jpg"), filename: "proyectores.jpg")
categoria9.image.attach(io: File.open("app/app/assets/images/controladores_dj.jpg"), filename: "controladores_dj.jpg")
categoria10.image.attach(io: File.open("app/app/assets/images/mesas_mezcla_Dj.jpg"), filename: "mesas_mezcla_Dj.jpg")
